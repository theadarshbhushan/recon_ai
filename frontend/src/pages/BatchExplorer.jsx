      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-xs">
          <div className="flex items-center justify-between mb-4">
            <h3 className="wise-card-title text-sm text-slate-900">Settlement Batches</h3>
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-10 pr-4 py-2.5 text-xs font-semibold text-slate-800 placeholder-slate-400 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 focus:outline-none"
            />
          </div>
            ...
            <>
              ...
              <div className="bg-white border border-slate-200/90 rounded-2xl p-6 sm:p-8 shadow-xs">
                <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-100">
                  <div>
                    <span className="wise-eyebrow text-blue-600">Settlement Verification</span>
                    <h2 className="wise-section-title text-2xl text-slate-900 mt-1">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  ...
                  <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200/80">
                    ...
                    <div className="text-xs font-bold text-blue-600 mt-1 truncate">{batchDetail.algorithm_used}</div>
                  </div>
                  <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200/80">
                    ...
                    <tbody className="divide-y divide-slate-100 text-xs font-medium text-slate-700">
                      {batchDetail.constituents?.map((c, idx) => (
                        <tr key={idx} className="hover:bg-slate-50/80 transition-colors">
                          ...
                          <td className="py-3 px-4 text-right font-black text-blue-600 font-mono">{formatCurrency(c.net)}</td>
