    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="flex flex-wrap gap-3">
          {PRESETS.map((p, idx) => (
            <button
              ...
              className="rounded-full px-5 py-2 text-xs font-black bg-slate-100 hover:bg-[#FAF5E6] border border-slate-200 hover:border-[#E0B638] text-[#0A2540] transition-all cursor-pointer shadow-2xs hover-scale"
            >
              {p.name}
            </button>
          ))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white border border-slate-200/90 rounded-2xl p-6 sm:p-8 shadow-xs">
          <h3 className="wise-card-title text-base text-[#0A2540] mb-4 pb-3 border-b border-slate-100">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white border border-slate-300 rounded-xl px-3 py-2.5 text-xs font-semibold text-[#0A2540] focus:ring-2 focus:ring-[#0A2540]/20 focus:border-[#0A2540] focus:outline-none"
                />
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full bg-white border border-slate-300 rounded-xl px-3 py-2.5 text-xs font-bold text-[#0A2540] focus:ring-2 focus:ring-[#0A2540]/20 focus:border-[#0A2540] focus:outline-none"
                >
        ...
        <div className="bg-white border border-slate-200/90 rounded-2xl p-6 sm:p-8 shadow-xs flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-4 pb-3 border-b border-slate-100">
              <h3 className="wise-card-title text-base text-[#0A2540]">Model Verdict & Audit Explanation</h3>
              {result && (
            ...
            {result ? (
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200/80">
                    ...
                    <div className="text-2xl font-black text-[#C9A227] mt-1 font-mono">
              ...
              <div className="text-center py-16 text-slate-400 text-xs">
                <Zap className="h-8 w-8 mx-auto mb-2 opacity-40 text-[#C9A227]" />
