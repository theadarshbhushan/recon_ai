    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl shadow-xl overflow-hidden p-8">
        ...
        <p className="text-slate-400 text-xs mb-6">
          Register to launch your secure ledger audit panels.
        </p>
        ...
        {success && (
          <div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 px-4 py-3 rounded-xl text-xs font-semibold mb-6 flex items-center space-x-2">
            <span>✅</span>
